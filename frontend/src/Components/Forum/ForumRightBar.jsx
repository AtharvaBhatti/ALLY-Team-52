...
const ForumRightBar = () => {
    ...
    <ul class="Forum-Right-List">
      ...
      <li><a href="#" class="Forum-Right-Link">Link 3</a></li>
    ...
    <ul class="Forum-Right-List">
      ...
      <li><a href="#" class="Forum-Right-Link">Link 7</a></li>
      <li><a href="#" class="Forum-Right-Link">Link 8</a></li>
    </ul>
  </div>
    )
}
